...
/**
 * Botón flotante de WhatsApp: es la vía de contacto principal del sitio.
 *
 * Aparece después de bajar 400 px para no competir con el CTA del hero, que
 * ya lleva al mismo lugar.
 *
 * Solo el icono, sin texto. El glifo de WhatsApp se reconoce sin leer nada,
 * así que la etiqueta no añadía información y sí ocupaba ancho sobre el
 * contenido. El nombre accesible va en `aria-label`, de modo que quien navega
 * con lector de pantalla sigue oyendo a dónde lleva.
 */
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className={clsx(
        'group fixed bottom-5 right-5 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_6px_24px_rgba(37,211,102,0.35)] transition-all duration-500 ease-roll hover:scale-105 hover:shadow-[0_8px_32px_rgba(37,211,102,0.5)]',
        visible

...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className={clsx(
        'group fixed bottom-5 right-5 z-30 flex items-center gap-2.5 rounded-full bg-[#25D366] py-3 pl-4 pr-5 shadow-[0_6px_24px_rgba(37,211,102,0.35)] transition-all duration-500 ease-roll hover:shadow-[0_8px_32px_rgba(37,211,102,0.5)]',
        visible
